...
-   **MicrobiomeMetadataDictionary.csv** (Complementary):\
    Provides the equivalence between coded numerical values and their corresponding sample conditions.
...
-   Filtering Low-Abundance OTUs: Retained OTUs contributing up to **95% of cumulative abundance**. Additionally, removed OTUs with extremely low relative abundances.
...
```{r}
#| echo: false
clean_df_augm <- read_tsv("../data/03_metadata_long_filtered_taxonomy.tsv")

...
![](images/cumulative_abundance_OTU.png){width="628"}
:::
:::
:::
...
![](images/pc1vspc2-08.png){width="696"}
:::
...
![](images/pca_variance-14.png){width="580"}
:::

::: {.column width="60%" style="text-align: center; font-size: 22px;"}
![](images/pca_contributions-13.png){width="580"}
...
::: columns
::: {.column width="40%"}
::: {style="overflow-y: scroll; height: 600px; font-size: 22px;"}
...
![](images/clipboard-2422162524.png){width="800"}
:::
:::

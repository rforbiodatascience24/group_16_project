...
When comparing how the diets affect the microbiota in the different experiments one of the main differences we can see is the reduction in Bacteroidetes in the Western diet. This phenomenom is characteristic of obesity, thereby hinting at the link between this diet and said condition. As expected, the first generation ("Fresh" donor) and second generation ("HMouse..." donor) mice present different composition in their microbiota. The diet that the second generation mice follow appears to be less influential on their microbial composition than the diet that their donor followed. Furthermore, diet has the most obvious effect in the first generation of mice.

### Firmicutes-Bacteroidetes Ratio

We will now calculate the Firmicutes-Bacteroidetes ratio for each diet, in the first generation of humanised mice.

...
If we observe the above figure we can find some interesting insights. Firstly, we can find differences in abundance among the different parts of the mice's gut
